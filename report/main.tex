...
as up to date as possible. We shall talk about the client-specific
implementations in a subsequent section.


\subsubsection{Shared state: \code{Arc<Mutex<T>{>}}}

When handling incoming connections, two problems arise,
